...
class HelperCurso extends HelperBase<Curso> {
  ...
  @override
  Future<int> delete(int id, {String semestre, int idDisciplina}) async {
  ...
  @override
  Future<Curso> getFirst(int id, {String semestre, int idDisciplina}) async => db.then((database) async {
